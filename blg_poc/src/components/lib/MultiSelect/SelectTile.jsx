...
import { FormControl, Select, FormHelperText, MenuItem } from '@material-ui/core';
...
const SelectTile = ({
  ...
  return (
    <>
      <FormControl className={`${classes.margin} ${classNames.formControl}`} size="small" style={{maxWidth: '350px'}}>
